...
{
	private NakovHttpForwardServer mNakovForwardServer = null;
 
    /**
     * Creates a check alive thread. NakovForwardServer object is needed
     * for obtaining the servers list.
     */
    public CheckAliveThread(NakovHttpForwardServer aNakovForwardServer)
    {
    ...
    {
        NakovHttpForwardServer.ServerDescription[] servers = mNakovForwardServer.getServersList();
