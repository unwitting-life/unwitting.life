...
public interface MessageProcessingModel {
     ...
     * @param securityModel          the security model ID (see {@link SecurityModel}) to use.
     ...
     * @param messageProcessingModel   returns the message processing model (typically the SNMP version).
     * @param securityModel            returns the security model ID (see {@link SecurityModel}.
